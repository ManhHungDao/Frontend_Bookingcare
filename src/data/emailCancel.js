export const emailCancel = (name, dataBooking) => {
  return `
                        ...
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 31px;font-family:'Cabin',sans-serif;" align="left">
                              ...
                              <div style="color: #e5eaf5; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 28px; line-height: 39.2px;"><strong><span style="line-height: 39.2px; font-size: 28px;">ĐÂY LÀ EMAIL THÔNG BÁO</span></strong>
                                  </span>
                                </p>
                              </div>
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                              ...
                              <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                ...
                                <p style="line-height: 160%; text-align: justify;">Chúng tôi xin gửi tới bạn thư này để thông báo về việc hủy lịch khám bệnh trực tuyến tại website khám bệnh online của chúng tôi. Chúng tôi đã nhận được thông tin từ bạn về việc không thể tham gia cuộc khám bệnh đã đặt vào
                                  ngày ${dataBooking.date} lúc ${dataBooking.time}.</p>
                                <p style="line-height: 160%; text-align: justify;"> </p>
                                <p style="line-height: 160%; text-align: justify;">Dưới đây là các chi tiết của lịch hẹn đã bị hủy:</p>
                                ...
                                <p style="line-height: 160%; text-align: justify;"> </p>
                                <p style="line-height: 160%; text-align: justify;">Chúng tôi xin lưu ý rằng việc hủy lịch khám bệnh đã đặt có thể ảnh hưởng đến chất lượng dịch vụ khám bệnh của bạn. Nếu bạn có nhu cầu khám bệnh lại trong tương lai, xin vui lòng đăng nhập vào tài khoản của bạn trên website
                                  khám bệnh online của chúng tôi để đặt lịch hẹn mới.</p>
                                <p style="line-height: 160%; text-align: justify;"> </p>
                                <p style="line-height: 160%; text-align: justify;">Nếu bạn có bất kỳ câu hỏi hay cần hỗ trợ thêm, xin vui lòng liên hệ với chúng tôi qua số điện thoại hoặc qua email.</p>
                                <p style="line-height: 160%; text-align: justify;"> </p>
